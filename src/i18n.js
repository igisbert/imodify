...
const strings = {
  en: {
    ...
    opt_removebg: 'Remove background using AI [fast|hq] (-b). fast=BEN2 (quick, default 219MB), hq=BiRefNet_512x512 (quality). Use PNG/WebP for transparency',
  ...
  es: {
    ...
    opt_removebg: 'Elimina fondo con IA [fast|hq] (-b). fast=BEN2 (rápido, por defecto 219MB), hq=BiRefNet_512x512 (calidad). Usa PNG/WebP para transparencia',
